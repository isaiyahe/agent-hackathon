...
/**
 * Mock driver for the REPRO panel, loaded only with ?mock=1 (standalone preview).
 *
 * Previews the analysis / verification states that are not wired to real data yet.
 * <ReproPanel /> only needs the props passed below.
 */
